...
<main class="max-w-md mx-auto px-4 py-4">
  ...
  <nav class="mb-4">
    <div class="flex items-center space-x-2 text-sm text-gray-600">
      ...
      <button data-breadcrumb="category1" class="breadcrumb-link" data-category1=${product.category1}>
        ${product.category1}
      </button>
      <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
      </svg>
      <button data-breadcrumb="category2" class="breadcrumb-link" data-category1=${product.category1} data-category2=${product.category2}>
        ${product.category2}
      </button>
    </div>
  </nav>
  ...
  <!-- 상품 목록으로 이동 -->
  <div class="mb-6">
    <button data-link="/" class="block w-full text-center bg-gray-100 text-gray-700 py-3 px-4 rounded-md 
